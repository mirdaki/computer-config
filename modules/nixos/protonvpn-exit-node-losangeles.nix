...
let
  cfg = config.protonvpn-exit-node-losangeles;
  identifier = "losangeles";
  city = "Los Angeles";
in
{
  options = {
    protonvpn-exit-node-losangeles.enable = lib.mkEnableOption "enable protonvpn-exit-node-losangeles module";

    protonvpn-exit-node-losangeles.wireguardPrivateKeyFile = lib.mkOption { type = lib.types.str; };
    protonvpn-exit-node-losangeles.tailscaleAuthKeyFile = lib.mkOption { type = lib.types.str; };
  };
